...
%Code for the paper "Adaptive optimal control for continuous-time linear systems based on policy iteration"_Problem1
...
% The following function gives the dynamics of the sytem. 
